...
{/* SCREENSHOT NEEDED: Home Assistant energy dashboard. Put the file in public/ and replace this comment with an image, e.g. ![Home Assistant energy dashboard](/it-was-the-cable-energy-dashboard.png) */}
